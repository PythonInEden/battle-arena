...
export const FORTRESS_LANG = {
  en: {
    ...
    citadelSealedMsg: "The massive iron doors of the Dark Citadel are sealed with dark ancient magic. You need the 🎺 Horn of Opening to blast open the gates!",
  ...
  vi: {
    ...
    citadelSealedTitle: "🏰 CỔNG PHÁO ĐÀI BỊ KHOÁ CHẶT!",
    citadelSealedMsg: "Cánh cổng sắt khổng lồ của Pháo Đài Tối bị yểm bùa cổ đại. Bạn cần có 🎺 Tù Và Khai Mở để phá tan phù ấn và mở cổng!",
