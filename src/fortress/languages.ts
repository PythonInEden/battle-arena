...
export const FORTRESS_LANG = {
  en: {
    ...
    teleportTargetPrompt: "🌀 SELECT TELEPORT DESTINATION: Click any explored Town or Sanctuary on the map!",
  ...
  vi: {
    ...
    teleportTargetPrompt: "🌀 CHỌN ĐIỂM DỊCH CHUYỂN: Nhấp vào bất kỳ Thành Trị hoặc Thánh Địa đã thám hiểm!",
